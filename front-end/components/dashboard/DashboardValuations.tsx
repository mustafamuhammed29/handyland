...
import { BarChart3, TrendingUp, Shield, ChevronRight, Plus, Clock, CheckCircle2, Package, Banknote } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <div className="border-t border-slate-800/50 pt-4 flex items-end justify-between">
                                ...
                                <div className="flex gap-2">
                                    <button className="p-2 rounded-xl bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-700 transition-colors" title="Details">
                ...
                {valuations.length === 0 && (
                    <div className="col-span-2 text-center py-12 text-slate-500">
                        ...
                        <p className="text-sm mb-4">Hol dir jetzt eine kostenlose Bewertung für dein Gerät</p>
                        <button
                            onClick={() => navigate('/valuation')}
                        ...
                        >
                            <Plus className="w-4 h-4" /> Gerät bewerten
                        </button>
                    </div>
                )}
            </div>
