                ...
                <div className="glass-modern rounded-[2.5rem] p-8 md:p-10 border border-slate-700/50 shadow-2xl relative overflow-hidden bg-slate-900/40 backdrop-blur-2xl">
                    ...
                    {false ? null : (
                        <form className="space-y-4" onSubmit={handleAuth}>
                            ...
                            <button
                                disabled={isLoading}
                                className={`w-full py-4 rounded-2xl font-black text-white shadow-xl flex items-center justify-center gap-3 transition-all active:scale-95 disabled:opacity-50 mt-4 uppercase tracking-widest ${mode === 'register' ? 'bg-gradient-to-r from-emerald-600 to-cyan-600' : 'bg-gradient-to-r from-brand-primary to-brand-secondary'
                                    }`}
                            >
