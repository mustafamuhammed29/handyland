            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-slate-900/50 backdrop-blur-md border border-slate-800 rounded-3xl p-8">
                    ...
                    <div className="space-y-8">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">User Obligations</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Returns & Refunds</h2>
                            <p className="text-slate-700 dark:text-slate-300">14-day return policy on all products. Contact support for refund requests.</p>
                        </section>

                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Repairs</h2>
                            <p className="text-slate-700 dark:text-slate-300">Repair estimates provided within 24 hours. 90-day warranty on all repairs.</p>
                        </section>
                    </div>
                </div>
            </div>
