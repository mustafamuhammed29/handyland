...
const SocialButton: React.FC<{ provider: 'google' | 'facebook'; disabled?: boolean }> = ({ provider }) => {
    ...
    const label = isGoogle
        ? t('auth.googleComingSoon', 'Mit Google fortfahren (Demnächst)')
        : t('auth.facebookComingSoon', 'Mit Facebook fortfahren (Demnächst)');
    const bg = isGoogle
    ...
    return (
        <button
            ...
            aria-disabled="true"
            aria-label={label}
            title={t('auth.socialUnavailable', 'Social Login ist derzeit nicht verfügbar')}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pl-11 pr-4 py-3 bg-white dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    required
                                    className="w-full pl-11 pr-11 py-3 bg-white dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                />
                                <button
                                    type="button"
