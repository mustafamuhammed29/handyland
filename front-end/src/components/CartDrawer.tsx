                    ...
                    <div className="bg-white dark:bg-slate-800/50 rounded-lg p-3 border border-slate-200 dark:border-slate-700 shadow-sm dark:shadow-none">
                        <div className="flex items-center gap-2 text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">
                            ...
                            {remainingForFreeShipping > 0
                                ? <span>Add <span className="text-emerald-500 dark:text-emerald-400">{/* FIXED: Use formatPrice for consistent currency display */}{formatPrice(remainingForFreeShipping)}</span> for Free Shipping</span>
                                : <span className="text-emerald-500 dark:text-emerald-400">You've unlocked Free Shipping!</span>
                            }
                        </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar">
                    {cart.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <h4 className="text-xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Your cart is empty</h4>
                            ...
                            >
                                <span className="relative z-10">{t('shopNow', 'Start Shopping')}</span>
