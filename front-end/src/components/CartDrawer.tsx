                                        ...
                                        <div className="flex-1 min-w-0 flex flex-col justify-between">
                                            <div>
                                                <div className="flex justify-between items-start">
                                                 ...
                                                 <div className="text-xs text-slate-400 truncate mt-0.5">{(item.subtitle && item.subtitle !== 'null' && !item.subtitle.includes('null • null')) ? item.subtitle : (item.category && (item.category as string) !== 'null' ? item.category : '')}</div>
                                            </div>
