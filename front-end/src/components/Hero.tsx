            ...
            <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
                ...
                >
                    <div className="inline-flex items-center justify-center lg:justify-start gap-2 px-4 py-2 rounded-full bg-slate-900/50 border border-slate-700 backdrop-blur-md animate-in slide-in-from-bottom-4 fade-in duration-700">
                        ...
                        <span className="text-xs font-bold tracking-widest uppercase" style={{ color: settings.hero.accentColor }}>
                            {language === 'de' && settings.hero.tagline ? settings.hero.tagline : t('hero.tagline', "Deutschlands #1 Tech-Hub")}
                        </span>
                    </div>
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-black text-slate-900 dark:text-white leading-[1.1] md:leading-none tracking-tight whitespace-pre-line">
                        {language === 'de' && settings.hero.headline && settings.hero.headline.trim().length > 1
                            ? settings.hero.headline
                            : t('hero.headline', 'HandyLand Premium Tech Hub')}
                    </h1>
                    ...
                    <p className="text-base md:text-lg text-slate-400 max-w-lg leading-relaxed border-l-0 lg:border-l-2 border-slate-800 pl-0 lg:pl-4 md:pl-6 mx-auto lg:mx-0 text-center lg:text-left">
                        {language === 'de' && settings.hero.subheadline
                            ? settings.hero.subheadline
                            : (language === 'ar' && settings.hero.subheadlineAr
                                ? settings.hero.subheadlineAr
                                : t('hero.subheadline', 'Entdecke die Zukunft des mobilen Handels. Kaufen, Verkaufen und Reparieren mit deutscher Präzision.'))}
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 md:gap-4 pt-4 w-full md:w-auto">
                        ...
                        >
                            ...
                            <span className="relative flex items-center justify-center gap-1 md:gap-2 text-center">
                                {(language === 'de' && settings.hero.buttonMarket ? settings.hero.buttonMarket : t('hero.shopNow', 'Jetzt einkaufen'))} {isRtl ? <ArrowLeft className="w-3 h-3 md:w-5 md:h-5 shrink-0" /> : <ArrowRight className="w-3 h-3 md:w-5 md:h-5 shrink-0" />}
                            </span>
                        </button>
                        ...
                        <div className="flex flex-col sm:contents gap-3">
                            ...
                            >
                                ...
                                <span>{language === 'de' && settings.hero.buttonValuation ? settings.hero.buttonValuation : t('hero.sellDevice', 'Gerät verkaufen')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span>{t('hero.trackRepair', 'Reparatur verfolgen')}</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 w-full max-w-md mx-auto lg:mx-0 pt-4 md:pt-8 mb-6 md:mb-12">
                        <div className="group flex flex-col items-center justify-center text-center md:flex-row md:text-left border border-slate-200 dark:border-slate-800/50 rounded-lg px-2 py-1.5 md:px-4 md:py-2 bg-white/50 dark:bg-slate-900/30 hover:border-emerald-500/30 transition-all min-w-0 w-full">
                            ...
                            <span className="text-[10px] md:text-xs leading-tight font-mono text-slate-600 dark:text-slate-300 group-hover:text-emerald-500 dark:group-hover:text-emerald-300 transition-colors truncate md:whitespace-normal">
                                {language === 'de' && settings.hero.trustBadge1 ? settings.hero.trustBadge1 : t('hero.trustBadge1', 'Verifizierte Händler')}
                            </span>
                        </div>
                        <div className="group flex flex-col items-center justify-center text-center md:flex-row md:text-left border border-slate-200 dark:border-slate-800/50 rounded-lg px-2 py-1.5 md:px-4 md:py-2 bg-white/50 dark:bg-slate-900/30 hover:border-blue-500/30 transition-all min-w-0 w-full">
                            ...
                            <span className="text-[10px] md:text-xs leading-tight font-mono text-slate-600 dark:text-slate-300 group-hover:text-blue-500 dark:group-hover:text-blue-300 transition-colors truncate md:whitespace-normal">
                                {language === 'de' && settings.hero.trustBadge2 ? settings.hero.trustBadge2 : t('hero.trustBadge2', '24/7 Support')}
                            </span>
                        </div>
                        <div className="group flex flex-col items-center justify-center text-center md:flex-row md:text-left border border-slate-200 dark:border-slate-800/50 rounded-lg px-2 py-1.5 md:px-4 md:py-2 bg-white/50 dark:bg-slate-900/30 hover:border-purple-500/30 transition-all min-w-0 w-full">
                            ...
                            <span className="text-[10px] md:text-xs leading-tight font-mono text-slate-600 dark:text-slate-300 group-hover:text-purple-500 dark:group-hover:text-purple-300 transition-colors truncate md:whitespace-normal">
                                {language === 'de' && settings.hero.trustBadge3 ? settings.hero.trustBadge3 : t('hero.trustBadge3', '4,9★ bewertet')}
                            </span>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="absolute bottom-6 md:bottom-8 left-5 md:left-6 right-5 md:right-6">
                                <div className="flex justify-between items-end mb-4 gap-3">
                                    <div className="flex-1 min-w-0">
                                        <div className="text-brand-primary text-[10px] md:text-xs font-bold mb-1 truncate">
                                            {language === 'de' && settings.hero.productLabel && settings.hero.productLabel !== 'FEATURED DEVICE'
                                                ? settings.hero.productLabel
                                                : t('hero.featuredDeviceLabel', 'Empfohlenes Gerät')}
                                        </div>
                    ...
                    >
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <div className="min-w-0 flex-1 overflow-hidden">
                                <div className="text-[9px] md:text-xs text-slate-400 whitespace-normal leading-tight">
                                    {language === 'de' && settings.hero.stat1Title ? settings.hero.stat1Title : t('hero.salesStatLabel', 'Geräte verkauft')}
                                </div>
                                <div className="text-[11px] md:text-base text-cyan-400 font-bold whitespace-normal leading-tight">
                                    {language === 'de' && settings.hero.stat1Value ? settings.hero.stat1Value : t('hero.salesStatValue', '+24% diese Woche')}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <div className="min-w-0">
                                <div className="text-[9px] md:text-xs text-slate-400 whitespace-nowrap">
                                    {language === 'de' && settings.hero.stat2Title ? settings.hero.stat2Title : t('hero.ratingStatLabel', 'Kundenbewertung')}
                                </div>
                                <div className="text-[11px] md:text-base text-slate-900 dark:text-white font-bold whitespace-nowrap">
                                    {language === 'de' && settings.hero.stat2Value ? settings.hero.stat2Value : t('hero.ratingStatValue', '4,9/5,0 Ausgezeichnet')}
                                </div>
                            </div>
                        </div>
                    </div>
