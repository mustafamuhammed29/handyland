    ...
    return (
        ...
        >
            <div className="flex-1 p-6 flex flex-col">
                <div className="mb-6">
                    <h3 className="text-white font-bold text-lg">Wie können wir helfen?</h3>
                    <p className="text-slate-400 text-sm mt-1">Beschreibe dein Anliegen oder deine Frage. Unser Team antwortet in Kürze.</p>
                </div>
