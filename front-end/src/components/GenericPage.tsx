        ...
        return (
            <section className="relative py-24 bg-black min-h-[100dvh]">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <div className="text-9xl font-black text-brand-primary opacity-20 mb-4">404</div>
                    ...
                    <Link
                        to="/"
                        className="inline-block bg-gradient-to-r from-brand-primary to-brand-secondary hover:from-brand-primary hover:to-brand-secondary text-white font-bold px-8 py-4 rounded-xl transition-all"
                    >
                        Return Home
                    </Link>
                </div>
        ...
        <section className="relative py-24 bg-black min-h-[100dvh]">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div
                    ...
                    prose-h2:text-2xl prose-h2:mb-3 prose-h2:mt-6 prose-h2:text-brand-primary
                ...
                <div className="mt-12 text-center">
                    <Link
                        to="/"
                        className="inline-block text-brand-primary hover:text-brand-primary font-medium transition-colors"
                    >
                        ← Back to Home
                    </Link>
                </div>
