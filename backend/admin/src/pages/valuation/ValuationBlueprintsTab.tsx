...
export const ValuationBlueprintsTab = () => {
    const activeSection: string = 'blueprints';
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto text-slate-100">
            ...
            <div className="flex gap-2 mb-8 border-b border-white/10 pb-0">
                <button
                    onClick={() => ((_val: string) => {})('blueprints')}
