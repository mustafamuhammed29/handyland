...
router.post('/admin/send', protect, authorize('admin', 'staff'), messageController.sendSingleAdminMessage);
...
router.put('/:id', protect, authorize('admin', 'staff'), messageController.updateMessageStatus);
